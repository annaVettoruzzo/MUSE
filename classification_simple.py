...
for it in range(iters):
    ...
    #MultiMAML(modelsC_maml, loss_fn, lr, adapt_steps=adapt_steps, lmbd=lmbd, lmbd_end=lmbd_end).fit(tgen, 20000*n_models, selection_steps, use_weight, adapt_weights)
...
# Aircraft
avg_accs, avg_accs_mmaml, avg_accs_tsamaml, avg_accs_multireptile, avg_accs_multimaml, \
std_accs, std_accs_mmaml, std_accs_tsamaml, std_accs_multireptile, std_accs_multimaml = averaging_results(path_dir, models_name_dir, task="0", metric="accs")
plot_compare_sota([avg_accs[:3], avg_accs[3:5], avg_accs[5:8], avg_accs[8:]], avg_accs_mmaml, avg_accs_tsamaml, names, idx_modes, all_modes_name, save=f"{path_dir}/avg_comparison_task0.png")
...
# Fungi
avg_accs, avg_accs_mmaml, avg_accs_tsamaml, avg_accs_multireptile, avg_accs_multimaml, \
std_accs, std_accs_mmaml, std_accs_tsamaml, std_accs_multireptile, std_accs_multimaml = averaging_results(path_dir, models_name_dir, task="1", metric="accs")
plot_compare_sota([avg_accs[:3], avg_accs[3:5], avg_accs[5:8], avg_accs[8:]], avg_accs_mmaml, avg_accs_tsamaml, names, idx_modes, all_modes_name, save=f"{path_dir}/avg_comparison_task1.png")
...
# Bird
avg_accs, avg_accs_mmaml, avg_accs_tsamaml, avg_accs_multireptile, avg_accs_multimaml, \
std_accs, std_accs_mmaml, std_accs_tsamaml, std_accs_multireptile, std_accs_multimaml = averaging_results(path_dir, models_name_dir, task="2", metric="accs")
plot_compare_sota([avg_accs[:3], avg_accs[3:5], avg_accs[5:8], avg_accs[8:]], avg_accs_mmaml, avg_accs_tsamaml, names, idx_modes, all_modes_name, save=f"{path_dir}/avg_comparison_task2.png")
